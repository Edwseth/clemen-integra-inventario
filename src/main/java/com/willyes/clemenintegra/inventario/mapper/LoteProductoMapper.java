...
public interface LoteProductoMapper {
    ...
    @Mapping(target = "estadoCalidadResumen", expression = "java(lote.getEstadoCalidadResumen())")
    ...
    @Mapping(target = "estadoCalidadResumen", expression = "java(entity.getEstadoCalidadResumen())")
