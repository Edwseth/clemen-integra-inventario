...
public class AjusteInventarioController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyAuthority('INV_READ','INV_WRITE','INV_AJUSTES_READ','INV_AJUSTES_WRITE')")
    public ResponseEntity<Page<AjusteInventarioResponseDTO>> listar(
        ...
        return ResponseEntity.ok(service.listar(sanitized, fechaInicio, fechaFin, productoId, almacenId));
    }

    @PostMapping
    @PreAuthorize("hasAnyAuthority('INV_WRITE','INV_AJUSTES_WRITE')")
