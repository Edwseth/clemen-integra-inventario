...
@RestController
@RequestMapping("/api/produccion/regularizaciones")
...
public class RegularizacionTrazabilidadController {
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('PROD_DECIDE','PROD_TRAZABILIDAD_REGULARIZACION')")
    public ResponseEntity<RegularizacionTrazabilidadResponseDTO> crear(
